...
all: bin/compare_vector bin/convert_road_dimacs_graph bin/test_customizable_contraction_hierarchy bin/test_basic_features bin/test_customizable_contraction_hierarchy_reset bin/test_contraction_hierarchy_extra_weight bin/test_customizable_contraction_hierarchy_perfect_customization bin/test_id_mapper bin/test_tag_map bin/export_road_dimacs_graph bin/compute_contraction_hierarchy bin/test_protobuf bin/test_bit_vector bin/examine_ch bin/generate_random_source_times bin/test_strongly_connected_component bin/test_label_restricted_dijkstra bin/test_contraction_hierarchy_pinned_query bin/graph_to_svg bin/show_path bin/generate_dijkstra_rank_test_queries bin/encode_vector bin/generate_random_node_list bin/test_id_set_queue bin/compute_nested_dissection_order bin/test_customizable_contraction_hierarchy_path_query bin/randomly_permute_nodes bin/test_customizable_contraction_hierarchy_pinned_query bin/convert_road_dimacs_coordinates bin/test_nested_dissection bin/test_inverse_vector bin/run_contraction_hierarchy_query bin/test_google_polyline bin/osm_extract bin/test_dijkstra bin/test_label bin/test_osm_simple bin/decode_vector bin/test_nearest_neighbor bin/test_sort bin/generate_constant_vector bin/test_buffered_asynchronous_reader bin/generate_test_queries bin/compute_geographic_distance_weights bin/run_dijkstra bin/graph_to_dot bin/test_customizable_contraction_hierarchy_customization bin/test_geo_dist bin/test_permutation bin/test_contraction_hierarchy_path_query lib/libroutingkit.a lib/libroutingkit.so
